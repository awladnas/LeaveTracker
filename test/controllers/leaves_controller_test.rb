...
class LeavesControllerTest < ActionController::TestCase
  ...
  test "should create leafe" do
    assert_difference('Leave.count') do
      post :create, leafe: { leave_date: @leafe.leave_date, leave_status: @leafe.leave_status, leave_type: @leafe.leave_type, user_id: @leafe.user_id }
    end
  ...
  test "should update leafe" do
    patch :update, id: @leafe, leafe: { leave_date: @leafe.leave_date, leave_status: @leafe.leave_status, leave_type: @leafe.leave_type, user_id: @leafe.user_id }
    assert_redirected_to leafe_path(assigns(:leafe))
  end
